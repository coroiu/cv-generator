...
let LocalStorageProviderService = class LocalStorageProviderService {
    constructor() { }
    observable$(key) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(window, 'storage')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(e => e.key === key), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(e => e.newValue), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["startWith"])(window.localStorage.getItem(key)));
    }
    set(key, value) {
...
let ResumeProviderService = class ResumeProviderService {
    constructor(http, route, router, storage) {
        this.storage = storage;
        this.resumeSubject$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]('');
        this.subscription = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])(this.storage.observable$(editingKey), this.storage.observable$(resumeKey), route.queryParamMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(m => {
            if (m.has(urlKey)) {
                return m.get(urlKey);
            }
            else {
        ...
        }))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(v => {
            const editing = JSON.parse(v[0]);
            console.log(editing);
            const resume = v[1];
            const url = v[2];
            if (editing) {
                ...
                return http.get(url, { responseType: 'text' })
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(r => this.storage.set(resumeKey, r)));
            }
        })).subscribe(this.resumeSubject$);
    }
    get resume$() {
        return this.resumeSubject$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(v => {
            try {
                return JSON.parse(v);
            }
            catch (_a) {
...
ResumeProviderService.ctorParameters = () => [
...
let ResumeSectionComponent = class ResumeSectionComponent {
    constructor() {
        this.name = undefined;
    }
    get classes() {
...
let ResumeComponent = class ResumeComponent {
    constructor(resumeProvider, themeProvider) {
        this.resumeProvider = resumeProvider;
    ...
    ngOnInit() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["combineLatest"])(this.resumeProvider.resume$, this.themeProvider.theme$).subscribe(v => {
            const resume = v[0];
            let theme = v[1];
            if (resume !== undefined && resume.meta !== undefined && 'theme' in resume.meta) {
                const overrides = resume.meta.theme;
...
let ThemeSectionComponent = class ThemeSectionComponent {
...
ThemeSectionComponent.ctorParameters = () => [
...
let ThemeProviderService = class ThemeProviderService {
    ...
    get theme$() {
        const themeUrl$ = this.route.queryParamMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(m => {
            if (m.has(urlKey)) {
                return m.get(urlKey);
            }
            else {
        ...
        return themeUrl$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(themeUrl => this.http
            .get(themeUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(t => {
            if (t.styleUrl) {
                return this.http
                    .get(t.styleUrl, { responseType: 'text' })
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(v => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(less__WEBPACK_IMPORTED_MODULE_5___default.a.render(v))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(v => {
                    t.style = v.css;
                    return t;
                }));
            }
...
ThemeProviderService.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }
];
