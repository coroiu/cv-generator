...
export class ResumeComponent implements OnInit, OnDestroy {
  @ViewChild("themeHost", { read: ViewContainerRef, static: false })
  ...
  ngOnInit() {
    ...
    combineLatest(
      ...
      if (
        resume !== undefined &&
        resume.meta !== undefined &&
        "theme" in resume.meta
      ) {
      ...
      document.head.querySelector("#dynamic-theme-supplemental").innerHTML =
        theme.styleSupplemental;
